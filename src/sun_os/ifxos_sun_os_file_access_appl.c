...
/* ============================================================================
   IFX Sun OS adaptation - Application Space, File Access
   ========================================================================= */

/** \addtogroup IFXOS_FILE_ACCESS_SUN_OS_APPL
@{ */
#if ( defined(IFXOS_HAVE_FILE_ACCESS) && (IFXOS_HAVE_FILE_ACCESS == 1) )
/**
   Sun OS Application - Open a file.
...
/**
   Sun OS Application - Close the file or memory file.
...
/**
   Sun OS Application - Flush a stream (file or pipe).
...
/**
   Sun OS Application - End of file test of a file.
...
/**
  Sun OS Application - Get file status info.
...
/** \addtogroup IFXOS_MEM_FILE_SUN_OS_APPL
@{ */
                  ...
                  const IFX_char_t  *pMode)
{
   ...
   tmpFd = tmpfile();
   /* set here the size of the tmp file */
...
/**
   Sun OS Application - Close the memory file.
