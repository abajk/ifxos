...
/* ============================================================================
   Description : IFX Sun OS adaptation - Print Handling (Application Space)
   ========================================================================= */
...
/* ============================================================================
   IFX Sun OS adaptation - Application Space, Print Handling
   ========================================================================= */
#if ( defined(IFXOS_HAVE_PRINT_STREAM) && (IFXOS_HAVE_PRINT_STREAM == 1) )
...
/**
   Sun OS Application - Set the user specific printout function for debug printouts.
...
/**
   Sun OS Application - Set the user specific printout function for error printouts.
