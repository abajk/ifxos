...
/* ============================================================================
   IFX Nucleus adaptation - User Space, Print Handling
   ========================================================================= */
#if ( defined(IFXOS_HAVE_PRINT_STREAM) && (IFXOS_HAVE_PRINT_STREAM == 1) )
...
/**
   Nucleus User - Set the user specific printout function for debug printouts.
...
/**
   Nucleus User - Set the user specific printout function for error printouts.
