...
/* ============================================================================
   IFX Nucleus adaptation - defines
   ========================================================================= */
#ifdef IFXOS_STATIC
#undef IFXOS_STATIC
#endif
...
/* ============================================================================
   IFX Nucleus adaptation - User Space, File Access
   ========================================================================= */

/** \addtogroup IFXOS_FILE_ACCESS_NUCLEUS_APPL
@{ */
#if ( defined(IFXOS_HAVE_FILE_ACCESS) && (IFXOS_HAVE_FILE_ACCESS == 1) )
/**
   Nucleus User - Open a file.
...
/**
   Nucleus User - Close the file or memory file.
...
/**
   Nucleus User - Read from a stream (file, stdin) number of elements with the
   given element size.
...
/**
   Nucleus User - Write to a stream (file, pipe, stdout) number of elements with
...
/**
   Nucleus User - Flush a stream (file or pipe).
...
/**
   Nucleus User - End of file test of a file.
...
/**
  Nucleus User - Get file status info.
...
/** \addtogroup IFXOS_MEM_FILE_NUCLEUS
@{ */
...
/**
   Nucleus user - Implementation of the missing function "fmemopen".
...
/**
   Nucleus User - Open a given memory buffer as stream (file).
...
#else
   stream = fmemopen(pMemBuf, bufSize_byte, pMode);
#endif
...
/**
   Nucleus User - Close the memory file.
