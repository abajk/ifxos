...
/* ============================================================================
   IFX eCos adaptation - User Space, Print Handling
   ========================================================================= */
#if ( defined(IFXOS_HAVE_PRINT_STREAM) && (IFXOS_HAVE_PRINT_STREAM == 1) )
...
/**
   eCos User - Set the user specific printout function for debug printouts.
...
/**
   eCos User - Set the user specific printout function for error printouts.
