...
/* ============================================================================
   IFX Linux adaptation - Application Space, File Access
   ========================================================================= */

/** \addtogroup IFXOS_FILE_ACCESS_LINUX_APPL
@{ */
#if ( defined(IFXOS_HAVE_FILE_ACCESS) && (IFXOS_HAVE_FILE_ACCESS == 1) )
/**
   LINUX Application - Open a file.
...
/**
   LINUX Application - Close the file or memory file.
...
/**
   LINUX Application - Read from a stream (file, stdin) number of elements with the
   given element size.
...
/**
   LINUX Application - Write to a stream (file, pipe, stdout) number of elements with
...
/**
   LINUX Application - Flush a stream (file or pipe).
...
/**
   LINUX Application - End of file test of a file.
...
/**
  LINUX Application - Get file status info.
...
/** \addtogroup IFXOS_MEM_FILE_LINUX_APPL
@{ */
#if ( defined(IFXOS_HAVE_MEMORY_FILE) && (IFXOS_HAVE_MEMORY_FILE == 1) )

/**
   LINUX Application - Open a given memory buffer as stream (file).
...
/**
   LINUX Application - Close the memory file.
