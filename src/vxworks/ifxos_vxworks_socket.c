...
/**
   VxWorks - Receives data from a datagram socket.
...
/**
   VxWorks - Assigns a local address to a TCP/IP, UDP/IP or raw socket.
...
/**
   VxWorks - Establish a connection by a TCP client.
