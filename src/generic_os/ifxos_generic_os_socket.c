...
/** \addtogroup IFXOS_SOCKET_GENERIC_OS
@{ */

#if ( defined(IFXOS_HAVE_SOCKET) && (IFXOS_HAVE_SOCKET == 1) )
/**
   GENERIC_OS - This function init and setup the socket feature on the system.

\par Implementation
   - Nothing under GENERIC_OS.
...
/**
   GENERIC_OS - This function cleanup the socket feature on the system.
...
/**
   GENERIC_OS - This function creates a TCP/IP, UDP/IP or raw socket.
...
/**
   GENERIC_OS - Pend (wait) on multiple file descriptors.
...
/**
   GENERIC_OS - Receives data from a connected socket.
...
/**
   GENERIC_OS - Sends data to connected socket.
...
/**
   GENERIC_OS Application - Sends data to UDP socket.
...
/**
   GENERIC_OS - Assignes a local address to a TCP/IP, UDP/IP or raw socket.
...
/**
   GENERIC_OS - Indicates that the server is willing to accept connection requests from
...
/**
   GENERIC_OS - Accept a Connection from the socket.
...
/**
   GENERIC_OS - Establisch a connection by a TCP client.
...
/**
   GENERIC_OS - This function converts a network address to dotted decimal notation.
...
/**
   GENERIC_OS - Mark a descriptor in use.
...
/**
   GENERIC_OS - Clear a given descriptor.
...
/**
   GENERIC_OS - Check if a descriptor is set.
...
/**
   GENERIC_OS - Clear a descriptor mask.
