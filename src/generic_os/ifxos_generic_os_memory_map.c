...
/* ============================================================================
   IFX GENERIC_OS Adaptation Frame - memory mapping
   ========================================================================= */
/** \addtogroup IFXOS_MEMORY_MAP_GENERIC_OS_DRV
@{ */

/**
   GENERIC_OS - Map the physical address to a virtual memory space.
   For virtual memory management this is required.

\par Implementation
   Under GENERIC_OS there is no virtal memory management required.
...
/**
   GENERIC_OS - Release the virtual memory range of a mapped physical address.
   For virtual memory management this is required.
