...
/* ============================================================================
   RTEMS Adaptation Frame - defines
   ========================================================================= */
#ifdef IFXOS_STATIC
#undef IFXOS_STATIC
#endif
...
/* ============================================================================
   RTEMS Adaptation Frame - User Space, File Access
   ========================================================================= */

/** \addtogroup IFXOS_FILE_ACCESS_RTEMS_APPL
@{ */
#if ( defined(IFXOS_HAVE_FILE_ACCESS) && (IFXOS_HAVE_FILE_ACCESS == 1) )
/**
   RTEMS User - Open a file.
...
/**
   RTEMS User - Close the file or memory file.
...
/**
   RTEMS User - Read from a stream (file, stdin) number of elements with the
   given element size.
...
/**
   RTEMS User - Write to a stream (file, pipe, stdout) number of elements with
...
/**
   RTEMS User - Flush a stream (file or pipe).
...
/**
   RTEMS User - End of file test of a file.
...
/**
  RTEMS User - Get file status info.
...
/** \addtogroup IFXOS_MEM_FILE_RTEMS
@{ */
...
/**
   RTEMS user - Implementation of the missing function "fmemopen".
...
/**
   RTEMS User - Open a given memory buffer as stream (file).
