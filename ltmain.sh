...
if test -n "$STAGING_DIR"; then
	...
	: ${EGREP="/local-hdd/lobuchox/ugw/axepoint/8.5.0_20201112T153330/ugw_sw/openwrt/staging_dir/host/bin/grep -E"}
	: ${FGREP="/local-hdd/lobuchox/ugw/axepoint/8.5.0_20201112T153330/ugw_sw/openwrt/staging_dir/host/bin/grep -F"}
	: ${GREP="/local-hdd/lobuchox/ugw/axepoint/8.5.0_20201112T153330/ugw_sw/openwrt/staging_dir/host/bin/grep"}
	: ${SED="/local-hdd/lobuchox/ugw/axepoint/8.5.0_20201112T153330/ugw_sw/openwrt/staging_dir/host/bin/sed"}
fi
